      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        <div className="text-center max-w-3xl mx-auto space-y-2">
          ...
          <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
            MYDMS governs three distinct user roles, each with tailored permissions, dedicated dashboards, and explicit workflow responsibilities.
          </p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-xs border-t border-slate-100 pt-3">
                ...
                <ul className="space-y-1.5 text-slate-600">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600 shrink-0 mt-0.5" />
                    <span>Collaborate with client via direct messaging and upload final design archives.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600 shrink-0 mt-0.5" />
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-xs border-t border-slate-100 pt-3">
                ...
                <ul className="space-y-1.5 text-slate-600">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-slate-900 shrink-0 mt-0.5" />
                    <span>Broadcast operational notices and manage platform governance.</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-slate-200 pb-6">
            <div className="space-y-1">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">
                How MYDMS Operates (5-Stage Lifecycle)
              </h2>
